...
const BUILD = /* comps */ { hydratedSelectorName: "hydrated", lazyLoad: false, updatable: true, watchCallback: false };
...
export { H, format, getAssetPath, h, proxyCustomElement as p, setAssetPath, setNonce, setPlatformOptions };
